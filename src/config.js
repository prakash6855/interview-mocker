...
export const config = {
    ...
    css: [
      ...
      "What are `rem` and `em` units in CSS?",
      "How do you create CSS custom properties?",
      "What are the best practices for organizing CSS code?",
      "How do you use CSS Grid to create complex layouts?",
      "What is the purpose of the `position` property?",
      "How do you apply styles to pseudo-elements like `::before` and `::after`?",
      "What is the `background` shorthand property?",
      "How do you create a CSS sticky footer?",
      "What are CSS preprocessors like Sass and Less?",
      "How do you use CSS to create a responsive navigation menu?",
      "What are some common performance optimization techniques in CSS?",
      "How do you implement a grid-based layout with Flexbox?",
      "What are CSS logical properties and how do they work?",
    ],
    nodejs: [
